...
extern void test_detector(char *datacfg, char *cfgfile, char *weightfile, char **filename, int n_files, float thresh, float hier_thresh, char *outfile, int fullscreen);
...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        int n_filenames = argc - 4;
        test_detector("cfg/corvid.data", argv[2], argv[3], argv+4, n_filenames, thresh, .5, outfile, fullscreen);
